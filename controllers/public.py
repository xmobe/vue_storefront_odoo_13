...
class PublicAPIController(http.Controller):
    ...
    @http.route('/api/catalog/vue_storefront_catalog/product/_search', methods=['GET', 'OPTIONS'], type='http',
    ...
    @http.route('/api/catalog/vue_storefront_catalog/attribute/_search', methods=['GET', 'OPTIONS'], type='http',
                auth='none', csrf=False)
    ...
    @http.route('/api/catalog/vue_storefront_catalog/category/_search', methods=['GET', 'OPTIONS'], type='http',
                auth='none', csrf=False)
    ...
    @http.route('/api/catalog/vue_storefront_catalog/review/_search', type='http', auth="none", methods=['OPTIONS'],
                csrf=False)
    ...
    @http.route('/api/catalog/vue_storefront_catalog/review/_search', methods=['GET', 'OPTIONS'], type='http',
                auth='none', csrf=False)
